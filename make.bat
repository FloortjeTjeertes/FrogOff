...
"tools/ld65.exe" bin/nes.o bin/loadMetaSprite.o bin/loadBackground.o bin/TitleScreen.o bin/SinglePlayer.o bin/Debug.o  bin/LoadEntitie.o bin/playerPhysics.o bin/RenderEntities.o bin/RunEntitie.o bin/Increase.o bin/ButtonReading.o -o bin/%outputname%.nes -t nes --dbgfile bin\%outputname%.dbg
if errorlevel 1 (
    echo Linking failed.
