...
"tools/ld65.exe" bin/nes.o bin/loadMetaSprite.o bin/loadBackground.o bin/TitleScreen.o bin/SinglePlayer.o bin/Debug.o  bin/LoadEntity.o bin/playerPhysics.o bin/RenderEntities.o bin/RunEntity.o bin/Increase.o bin/Decrease.o bin/Add.o bin/ButtonReading.o bin/flyPhysics.o  bin/clearSprites.o -o bin/%outputname%.nes -t nes --dbgfile bin\%outputname%.dbg
if errorlevel 1 (
    echo Linking failed.
